...
${scriptdir}/cross_bold_pp_2019_NORDIC.csh $1 $2 > ${patid}_cross_bold_pp_2019_NORDIC.log || exit $status
if ( $doexit ) exit
...
foreach run ( $runID )
        ...
        set file = $patid"_b"${run}_${procstring}_on_${outspacestr}.4dfp.ifh || exit $status
...
foreach run ( $runID )
        set volume = "${wrkdir}/bold${run}/$patid"_b"${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_avg.nii.gz"
        set outname = "${wrkdir}/atlas/$patid"_b"${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_avg_regcheck"
...
${scriptdir}/RibbonVolumetoSurfaceMapping_090821_SE.csh $1 $2 || exit $status
if ( $doexit ) exit
...
if ( $#FCrunID ) then
${scriptdir}/SE_fcMRI_preproc_2019.csh $1 $2 > ${patid}_SE_fcMRI_preproc_2019.log || exit $status
else
endif
if ( $doexit ) exit
...
foreach run ( $FCrunID )
        ...
        set FUNCname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}.4dfp.img"
        set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}"
echo    matlab -batch "make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
        ...
        set FUNCname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_bpss.4dfp.img"
        set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_bpss"
echo    matlab -batch "make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
        matlab -batch "make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"

        set FUNCname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_bpss_resid.4dfp.img"
        set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_bpss_resid"
echo    matlab -batch "make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
        matlab -batch "make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
        popd
end
...
${scriptdir}/SurfaceMappingCiftiCreation_v3_SE.csh $1 $2 || exit $status
if ( $doexit ) exit