...
foreach run ( ${runID} ) 
	...
	set funcvol = ${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}${FCprocaddstring}
    echo ${funcvol}
    set goodvoxels = ./goodvoxels/${patid}_b${run}_faln_dbnd_xr3d_uwrp_on_${outspacestr}_goodvoxels
    rm -f ${funcvol}.nii*
