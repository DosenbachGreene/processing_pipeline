...
${scriptdir}/ME_cross_bold_pp_2019_210822_NORDIC_MESEFM.csh $1 $2 > ${patid}_ME_cross_bold_pp_2019_210822_NORDIC_MESEFM.log || exit $status
exit $status
if ( $doexit ) exit
...
${scriptdir}/ME_fcMRI_preproc_2019.csh $1 $2 > ${patid}_ME_fcMRI_preproc_2019.log || exit $status
if ( $doexit ) exit
...
foreach run ( $FCrunID )
	...
	set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_xr3d_uwrp_on_${outspacestr}_Swgt_norm"	
echo    matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
	matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"

	set FUNCname = "${basedir}/bold${run}/${patid}_b${run}_faln_xr3d_uwrp_on_${outspacestr}_Swgt_norm_bpss.4dfp.img"
	set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_xr3d_uwrp_on_${outspacestr}_Swgt_norm_bpss"	
echo    matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
	matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
	...
	set OUTname = "${basedir}/bold${run}/${patid}_b${run}_faln_xr3d_uwrp_on_${outspacestr}_Swgt_norm_bpss_resid"	
echo    matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
	matlab -batch 
"make_grayplots_TL('${rdatfile}','${ddatfile}','${WBname}','${GMname}','${WMname}','${CSFname}','${EXname}','${FUNCname}',${TR_vol},-150,150,'${OUTname}')"
...
${scriptdir}/SurfaceMappingCiftiCreation_v2.csh $1 $2 || exit $status
if ( $doexit ) exit
